...
// 静态成员初始化
PJ *GeoTransform::projTransform = nullptr;
PJ_CONTEXT *GeoTransform::projContext = nullptr;
...
std::string GeoTransform::lastError = "";
...
void GeoTransform::Init(PJ *transform, double *origin)
{
    ...
    GeoTransform::IsENU = false;  // Default to non-ENU
