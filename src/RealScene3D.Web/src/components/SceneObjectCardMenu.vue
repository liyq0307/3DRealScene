<template>
  <!--
    ...
    提供预览、编辑、切片、删除操作选项
  -->
  <div class="scene-object-card-menu" @click.stop role="menu" aria-label="场景对象操作菜单">
    <button
      class="menu-item"
      @click="handlePreview"
    ...
    <button
      ...
      :disabled="slicingDisabled"
      :title="slicingDisabled ? slicingDisabledReason : ''"
      role="menuitem"
    >
      <span class="item-icon">🔪</span>
      <span class="item-text">切片</span>
    </button>
 ...
 * 处理切片
 */
const handleSlicing = (): void => {
  if (!props.slicingDisabled) {
    emit('slicing')
  }
}
